...
var $$={}
$$.Uk={"":"Tp;",
call$1:function(a){$.Qy($.pJ(),a)}}
$$.ae={"":"Tp;",
call$1:function(a){$.Qy($.pJ(),"<h2 class=\"error\">NOT FOUND!</h2>")}}
$$.aL={"":"mW;",
...
z=$.j7()
y=$.K4()
this.LV(this,a,$.Pc(y,$.lf($globalState.N0)))
y.t1=new $.hC(z,y)
return z.MM},
$isbC:true}
$$.hC={"":"Tp;a,b",
...
e=$.U6(d)
x=e.gB(d)
for(y=$.U6(f),w=0;$.DAa.C(w,x);++w)c.u(c,this.fQ(e.t(d,w)),this.fQ(y.t(f,w)))
return c}}}
$$.yH={"":"a;wk,Ch,aQ?",
...
return z[b]},
grW:function(){return this.vl.length-1},
$isOd:true}
$$.O0={"":"a;MM,Mb",
...
x=this.a
if(y){if(x.Mb)$.vh($.w("Future already completed"))
x.Mb=!0
x.MM.tV(z)}else x.pm(a)}}
$$.G3={"":"Tp;c",
...
case 1:a=0
z=0
for(;$.DAa.C(z,c);++z)d.appendChild(b.t(b,0))}return}for(d=$.GP(b),y=this.I3;d.G()===!0;)y.appendChild(d.gl())}},
mv:function(a){var z=this.grZ(this)
...
gA:function(a){return $.U7.gA(this.I3.childNodes)},
...
this.UZ(this,b,z)},
h:function(a,b){this.vD.I3.appendChild(b)},
FV:function(a,b){var z,y
for(z=$.GP(b),y=this.vD.I3;z.G()===!0;)y.appendChild(z.gl())},
UZ:function(a,b,c){$.Ca.aN($.Ca.D6(this.gmJ(),b,c),new $.wP())},
V1:function(a){this.vD.I3.textContent=""},
mv:function(a){var z=this.grZ(this)
if(z!=null)$.Mp(z)
return z},
...
$$.Nh={"":"vB;",
bu:function(a){return a.toString()}}
$$.cv={"":"uH;D4:children=,iP:id=,hf:innerHTML}",
...
z=$.ru($.U9.gmW(window))
if($.xC(z,"/")===!0)return"Page_One"
else{y=$.xd("\\/wiki\\/(.*)",!0,!1).ej(z)
if(typeof y==="object"&&y!==null&&!!$.x(y).$isOd&&y.grW()>0){x=y.vl
if(1>=x.length)throw $.e(1)
return x[1]}else return""}}
$.to=function(a){$.Kn("/page/"+$.d(a),null,null).Rx(new $.Uk(),new $.ae())}
...
if(b==null)b=$.Rs()
z=new Worker(b)
$.U10.sFq(z,function(e) { $.Mg.call$2(z, e); })
y=$globalState
x=y.Y7
y.Y7=x+1
$.U10.siP(z,x)
...
v=z.c
z.c=$.WB(v,1)
w.OA(y).ml(new $.UR(z,v))}if($.xC(z.c,0))return $.aQ($.U9u)
z.b=$.A(z.c)
z.a=$.j7()
return z.a.MM}
...
return s}}//@ sourceMappingURL=skopon.js.map
